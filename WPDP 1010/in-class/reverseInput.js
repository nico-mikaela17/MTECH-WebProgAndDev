...
function runOnInputChange() {
  ...
  let inputValueAsUppercase = inputValue.toUpperCase();

  let inputValueAsLowercase = inputValue.toLowerCase();


  backwardsElement.textContent = inputValueAsBackwards;
  upperElement.textContent = inputValueAsUppercase;
  lowerElement.textContent = inputValueAsLowercase;
}
